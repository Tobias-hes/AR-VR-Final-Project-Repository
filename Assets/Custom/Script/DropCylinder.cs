    ...
    void FixedUpdate()
    {
        ...
        if (cylinders != null)
        {
            ...
            else if(cylinders.Count ==0)
            {
                ...
                if(SceneManager.GetActiveScene() == SceneManager.GetSceneByName("ARScene"))
                {
                    
                    SceneManager.LoadScene("NoneArScene");
                    SceneManager.SetActiveScene(SceneManager.GetSceneByName("NoneArScene"));
                }
                else
                {
